...
8. Include at least 3 images using <figure> tags with this format:
   <figure class="my-8"><img src="https://image.pollinations.ai/prompt/ENCODED_DESCRIPTION?width=1200&height=600&nologo=true" alt="Description" class="w-full rounded-xl shadow-lg" /><figcaption class="text-center text-sm text-primary mt-3">Generated by NanoBanana Pro</figcaption></figure>
